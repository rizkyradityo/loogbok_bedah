  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 10px;">
      ...
      <div class="alert alert-warning text-center">
        <h4>Lupa Password</h4>
        <hr>
        <p>Harap hubungi administrator untuk reset password</p>
      </div>
      <hr>
      <p class="mb-1 text-center">
        <a href="<?php echo base_url('login') ?>">Login</a> | <a href="<?php echo base_url('login/register') ?>" class="text-center">Register</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
