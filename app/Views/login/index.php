  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 10px;">
      ...
      <div class="login-logo">
        <div class="row">
          <div class="col-md-12">
            <img style="height:200px;"  src="<?php echo base_url('assets/upload/image/'.$site['icon']) ?>" class="img img-fluid">
          </div>
...
<?php 
 ...
 echo form_open(base_url('login')); ?>
      ...
      <p class="mb-1 text-center">
        <a href="<?php echo base_url('login/lupa') ?>">Lupa Password?</a> | <a href="<?php echo base_url('login/register') ?>" class="text-center">Register</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
