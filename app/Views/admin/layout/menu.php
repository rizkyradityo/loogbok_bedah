        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/file_download') ?>" class="nav-link">
                  <i class="fas fa-table nav-icon"></i>
                  <p>Data File Download</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/file_download/tambah') ?>" class="nav-link">
                  <i class="fas fa-plus nav-icon"></i>
                  <p>Tambah File Download</p>
                </a>
              </li>
          ...
          <li class="nav-item">
           ...
           <!-- Events 
           <li class="nav-item">
            <a href="<?php echo base_url('admin/calendar_event') ?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/calendar_event/list') ?>" class="nav-link">
                  <i class="fas fa-table nav-icon"></i>
                  <p>Data Loogbook</p>
                </a>
              </li>
         ...
         <li class="nav-item"> 
            <a href="<?php echo base_url('admin/group_logbook') ?>" class="nav-link">
